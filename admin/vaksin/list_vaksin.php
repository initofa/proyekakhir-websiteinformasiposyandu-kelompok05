...
$result = mysqli_query($conn, "SELECT v.*, u.nama_lengkap as pembuat FROM vaksin v LEFT JOIN users u ON v.created_by = u.nik ORDER BY v.usia_rekomendasi ASC");
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-4 hover:shadow-xl transition flex flex-col h-full">
            <div class="flex justify-between items-start">
                ...
                <div>
                    <a href="edit_vaksin.php?id=<?php echo $row['id_vaksin']; ?>" class="text-blue-500 mr-2 hover:text-blue-700" title="Edit">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="hapus_vaksin.php?id=<?php echo $row['id_vaksin']; ?>" class="text-red-500 hover:text-red-700" title="Hapus" onclick="confirmDelete(event, this.href)">
