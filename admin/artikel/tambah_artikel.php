...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($_FILES['thumbnail']['name']){
        ...
        // Validasi ukuran (max 2MB = 2.000.000 bytes)
        ...
        elseif($file_error !== 0){
            ...
            // Gunakan timestamp Asia/Jakarta
    ...
    if(empty($error_upload)){
        $query = "INSERT INTO artikel (id_kategori, judul, konten, thumbnail, penulis_nik, created_by) 
                  VALUES ('$id_kategori', '$judul', '$konten', '$thumbnail', '$penulis_nik', '$created_by')";
