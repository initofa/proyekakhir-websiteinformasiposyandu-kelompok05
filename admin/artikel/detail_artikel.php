...
// PERUBAHAN UTAMA: Menangkap ID dari POST karena dipicu oleh form POST list_artikel.php
...
<div class="max-w-4xl mx-auto fade-in">
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div class="p-8">
            ...
            <div class="mt-8 pt-4 border-t border-gray-200">
                <div class="bg-gray-50 rounded-xl p-4">
                    <div class="text-sm text-gray-600">
                        ...
                        <!-- PERUBAHAN: Menggunakan fungsi formatTanggalIndonesia -->
            ...
            <!-- Action Buttons (Hanya menyisakan tombol kembali sesuai permintaan) -->
            <div class="flex mt-6">
